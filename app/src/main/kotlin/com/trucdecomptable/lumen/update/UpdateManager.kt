package com.trucdecomptable.lumen.update
...
import com.trucdecomptable.lumen.R
    ...
    fun start(context: Context) {
        ...
        scope.launch {
            ...
            if (canRequestInstalls(context)) {
                ...
                notify(
                    context,
                    "Lumen v${info.version} disponible",
                    info.notes,
...
private object BuildConfigHelper {
    fun isDebug(): Boolean = com.trucdecomptable.lumen.BuildConfig.DEBUG
}
